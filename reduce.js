...
of objects and a key and returns a new array with the value of each object at the key.
...
function vowelCount(str) {
    const vowels = 'aeiou';
    str = str.toLowerCase();
    return Array.from(str).reduce((a,b)=>{
...
Write a function called partition which accepts an array and a callback and returns an array
 ...
 each value in the array and if the result of the callback function at that specific value 
